...
const std::string default_complex_prompt = R"(The user wants to extract (OCR) all the text from the attached image.
...
const std::string default_simple_prompt = R"(The user wants to extract (OCR) all the text from the attached image.
